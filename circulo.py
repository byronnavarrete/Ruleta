...
# Función para dibujar la ruleta circular con colores correspondientes y un marco blanco
def draw_roulette(winning_number=None):
    center = (900, 300)
    radius = 200
    outer_radius = radius + 10  # Tamaño del marco blanco
    num_sectors = len(NUMEROS)
    angle_per_sector = 360 / num_sectors

    # Dibujar el marco blanco alrededor de la ruleta
    ...
    for i, num in enumerate(NUMEROS):
        ...
        # Dibujar cada sector usando polígonos
        points = [center]
    ...
    # Dibujar las líneas blancas que separan los sectores
    for i in range(num_sectors):
        angle = math.radians(i * angle_per_sector)
